...
def main() -> None:
    ...
    for taunt in taunts:
        ...
        with open(f"{taunts_folder}/{taunt['file']}", "wb") as fd:
            fd.write(resp.content)

    with open(f"{taunts_folder}/manifest.json", "w") as fd:
        json.dump(taunts, fd, indent=2)
